...
data = {'errcode': 0,
        'process_instance': {'attached_process_instance_ids': [], 'biz_action': 'NONE',
                             'business_id': '201903141457000214010',
                             'cc_userids': ['2504294407695839'], 'create_time': '2019-03-14 14:57:21',
                             'finish_time': '2019-03-14 14:57:41',
                             'form_component_values': [{'name': '监测点', 'value': '测试'},
                                                       {'name': '监测点物探号', 'value': '测试'},
                                                       {
                                                           'ext_value': '当前时间:2019-03-14 14:57:11\n当前地点:广西壮族自治区南宁市青秀区南湖街道茶花园路南湖碧园',
                                                           'name': '["当前时间","当前地点"]',
                                                           'value': '["2019-03-14 14:57:11",108.363742,22.825237,"广西壮族自治区南宁市青秀区南湖街道茶花园路南湖碧园",44]'},
                                                       {'name': '监测点外景照',
                             ...
                             'operation_records': [{'date': '2019-03-14 14:57:21', 'operation_result': 'NONE',
                                                   ...
                                                   {'date': '2019-03-14 14:57:40', 'operation_result': 'AGREE',
                                                    ...
                                                    'userid': 'manager405'},
                                                   {'date': '2019-03-14 14:57:40', 'operation_result': 'NONE',
                                                    'operation_type': 'NONE', 'remark': '', 'userid': 'manager405'}],
                             'originator_dept_id': '104659413', 'originator_dept_name': '水质组',
                             'originator_userid': 'manager405', 'result': 'agree', 'status': 'COMPLETED', 'tasks': [
                {'create_time': '2019-03-14 14:57:21', 'finish_time': '2019-03-14 14:57:41', 'task_result': 'AGREE',
                 'task_status': 'COMPLETED', 'taskid': '54246549221', 'userid': 'manager405'}],
                             'title': '梁昊提交的流量水质监测（容器法）'},
        'request_id': 'zzp0hjih2p1z'}
